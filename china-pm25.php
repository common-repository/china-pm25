...
Plugin URI: https://github.com/cisolarix/wordpress-pm25-widget
Description: Displays a pm 2.5 of the current visitor's city
Author: Yanming Deng
Version: 1.0
Author URI: https://github.com/cisolarix
*/
...
class Dym_Pm25 extends WP_Widget
{
  ...
  /**
   * get current visitor's city name according to its ip address
   */
  function getCity($ip)
  {
  ...
  /**
   * get current visitor's pm 2.5 according to its city name
   */
